...
(def bertramka {"wc" "Yes there are washroom's available"
     "attractions" "cultural monument, classical music concerts, social events"
     "biking" "Yes it is allowed"
     "skating" "No skating is not allowed"
     "sports" "false"
     "playground" "false"
...
(defn select-park [parks]
  (parks (remove-punctuation (read-line-with-prompt "Which park do you want information about? I've information about stromovka, bertramka, frantiskanska-zahrada, obora-hvezda, kampa, kinskeho-zahrada, klamovka, ladronka, letna, petrin, riegrovy-sady, vysehrad "))))
